...
interface GlowCardProps {
  children: ReactNode;
  className?: string;
  glowColor?: "violet" | "purple" | "violet" | "purple" | "violet";
  size?: "sm" | "md" | "lg";
  width?: string | number;
...
const GlowCard: React.FC<GlowCardProps> = ({
  ...
  useEffect(() => {
    ...
    // Only track mouse when card is in viewport
    ...
    const syncPointer = (e: PointerEvent) => {
      // Skip if card not visible or RAF already scheduled
